...
public class TaxiPool {
    private static final long EXPIRED_TIME_IN_MILISCOND = 1200;
    ...
    private void waitingUntilTaxiAvalable(){
        if (waiting.get()){
            waiting.set(false);
            throw new TaxiNotFoundException("No taxi avalable");
        }
        waiting.set(true);
        waiting(EXPIRED_TIME_IN_MILISCOND);
    }
